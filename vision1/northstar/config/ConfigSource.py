...
class NTConfigSource(ConfigSource):
    ...
    _frame_rate_sub: ntcore.IntegerSubscriber
    ...
    def update(self, config_store: ConfigStore) -> None:
        ...
        if not self._init_complete:
            ...
            self._camera_id_sub = nt_table.getStringTopic(
            ...
            self._frame_rate_sub = nt_table.getIntegerTopic(
                "frame_rate").subscribe(RemoteConfig.frame_rate)
        ...
        config_store.remote_config.frame_rate = self._frame_rate_sub.get()
        try:
